# 🌎 Earthquake Ground-Motion Prediction: Personal Fork

### Machine Learning + Deep Learning for Earthquake Ground-Motion Estimation

> This is a personal fork and working copy of [Utkarsh Rode's original project](https://github.com/UtkarshRode/seismic-ground-motion-prediction-ml). The original implementation, research, figures, and documentation remain credited to the original author. Any changes made in this fork should be documented here.

The project is distributed under the MIT License. See [LICENSE](LICENSE) for the required copyright and permission notice.
